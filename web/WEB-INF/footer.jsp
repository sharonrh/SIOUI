...
<div class="footer">
    <div class="container">
        ...
        <div class="footer-copyright">
            <p>&copy; Copyright 2014 <a href="#">SIOUI</a></p>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery.themepunch.plugins.min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery.themepunch.revolution.min.js"></script>
<!-- Masonry JS -->
<script src="<%=request.getContextPath()%>/js/masonry.pkgd.min.js"></script>
...
<!-- jQuery flot -->
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="<%=request.getContextPath()%>/js/excanvas.min.js"></script><![endif]-->
...
<script src="<%=request.getContextPath()%>/js/isotope.js"></script>
