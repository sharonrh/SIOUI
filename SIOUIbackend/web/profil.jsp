...
<form class="form-horizontal" role="form" method="POST" action="profil/edit" enctype="multipart/form-data">
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input name="nama_panjang" type="text" class="form-control" id="namaPanjang" value="<%if (org.getNamaPanjang() != null) {
                    out.print(org.getNamaPanjang());}%>">
        </div>
    </div>
    <div class="form-group">
        <label for="inputEmail" class="col-sm-2 control-label">Nama Pendek</label>
        <div class="col-sm-3">
            <input name="nama_pendek" type="text" class="form-control" id="inputEmail" value="<%if (org.getNamaPendek() != null) {
                    out.print(org.getNamaPendek());}%>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-1">
            <img name="logo_img" src="<%
                if (org.getLogo() != null) {
                    out.print("image?id="+ org.getIdOrganisasi() +"\\" + org.getLogo());
                }
